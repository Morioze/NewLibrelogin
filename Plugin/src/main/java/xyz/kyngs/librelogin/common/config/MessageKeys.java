...
public class MessageKeys {
    ...
    public static final ConfigurationKey<String> KICK_RATE_LIMITED = new ConfigurationKey<>(
            "kick-rate-limited",
            "You are attempting to log in too frequently! Please wait a moment and try again.",
            "This message is displayed when the player is kicked because they are attempting to log in too frequently from the same IP address. See the configuration key \"login-rate-limit-ms\" for more information.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> INFO_SESSION_IP_CHANGED = new ConfigurationKey<>(
            "info-session-ip-changed",
            "Your session has been invalidated because your IP address changed. Please log in again.",
            "This message is displayed when the player would have been logged in automatically, but their session was invalidated because they joined from a different IP address than the one the session was created on.",
            ConfigurateHelper::getString
    );
